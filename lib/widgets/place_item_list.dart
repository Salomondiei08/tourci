...
class PlaceListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () => Navigator.of(context).pushNamed('/place_info_screen', arguments: placeProvider.placeList[indexofPlace]),
      child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(children: [
                  ...
                  Text(placeProvider.placeList[indexofPlace].city!.name,
                ...
                Row(
                  children: [
                    Icon(Icons.favorite_border_outlined, color: AppTheme.orange),
                    SizedBox(width: 2.w),
                    Text(placeProvider.placeList[indexofPlace].numberOfLikes
                        .toString()),
                    SizedBox(width: 7.w),
                    Icon(Icons.message_outlined, color: AppTheme.orange),
                    SizedBox(width: 2.w),
                    Text(placeProvider.placeList[indexofPlace].comments.length
                        .toString())
                  ],
                )
              ],
